...
urlpatterns = [
    ...
    path("clusterevaluation/", views.ClusterListEvaluationViewSet.as_view({"post": "post"}),
    ...
    path("celldetailevaluation/", views.CellDetailEvaluationViewSet.as_view({"post": "post"}),
         name="celL_detail_evaluation"),
    path("genedetailevaluation/", views.GeneDetailEvaluationViewSet.as_view({"post": "post"}),
         name="gene_detail_evaluation"),
    path("organdetailevaluation/", views.OrganDetailEvaluationViewSet.as_view({"post": "post"}),
         name="organ_detail_evaluation"),
    path("clusterdetailevaluation/", views.ClusterDetailEvaluationViewSet.as_view({"post": "post"}),
    ...
    path("organevaluationform/", OrganSetEvaluationFormView.as_view(), name="organ_evaluation_form"),
    path("clusterevaluationform/", ClusterSetEvaluationFormView.as_view(), name="cluster_evaluation_form"),
    ...
    path("intersectionlist/", QuerySetIntersectionListView.as_view(), name="query_set_intersection_list"),
